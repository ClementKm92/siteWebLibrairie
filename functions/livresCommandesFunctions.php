...
function getOrderedBooks($accountId)
{
    try {
        //connexion to the database
        $database = dbConnect();
        // prepare query used to reduce the risk of sql injection
        $req = $database->prepare("SELECT orderId,bookTitle,quantity,orderDate,orderPrice from orderBook where accountId=:accountId");
